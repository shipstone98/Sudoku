...
namespace Sudoku
{
    ...
    public class SudokuMove
    {
        ...
        /// <summary>
        /// Gets a new array containing the zero-based <see cref="Sudoku"/> puzzle columns affected by the <see cref="SudokuMove"/>.
        /// </summary>
        public int[] Columns
		{
            get
        ...
        /// <summary>
        /// Gets a new array containing the zero-based <see cref="Sudoku"/> puzzle rows affected by the <see cref="SudokuMove"/>.
        /// </summary>
        public int[] Rows
		{
        ...
        /// </summary>
        /// <param name="rows">An array containing the zero-based <see cref="Sudoku"/> puzzle rows affected by the <see cref="SudokuMove"/>.</param>
        /// <param name="columns">An array containing the zero-based <see cref="Sudoku"/> puzzle columns affected by the <see cref="SudokuMove"/>.</param>
        ...
        /// Initializes a new instance of the <see cref="SudokuMove"/> class.
        /// </summary>
        /// <param name="row">The zero-based <see cref="Sudoku"/> puzzle row affected by the <see cref="SudokuMove"/>.</param>
        /// <param name="column">The zero-based <see cref="Sudoku"/> puzzle column affected by the <see cref="SudokuMove"/>.</param>
